package mk.finki.ukim.mk.lab_1.web.filter;
...
import mk.finki.ukim.mk.lab_1.constants.JwtConstants;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (headerValue == null || !headerValue.startsWith(JwtConstants.PREFIX)) {
            filterChain.doFilter(request, response);
            return;
        }

        String token = headerValue.substring(JwtConstants.PREFIX.length());
