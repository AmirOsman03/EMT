...
public class CountryApplicationServiceImpl implements CountryApplicationService {
    ...
    @Override
    public List<DisplayCountryDto> findByContinent(String continent) {
        return countryService.findByContinent(continent).stream().map(DisplayCountryDto::from).toList();
    }
